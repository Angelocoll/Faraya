...
const Gästlista = () => {
  ...
  const hämtaBokningar = async () => {
    ...
    try {
      ...
      const svar = await fetch(`https://app.waiteraid.com/wa-api/searchBooking?auth_hash=8e7eec36d57704ec37f2040f7d633cc4&restid=2905&email=saryzahir02@gmail.com`);
